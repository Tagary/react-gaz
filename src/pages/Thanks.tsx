...
const Thanks = () => {
  return <section className='thanks__page'>
      ...
      <div className='container thanks__maininfo'>
        ...
        <div className='thanks__info'> наш специалист свяжется
с вами в ближайшее время</div>
        <div className='container__button'><button className='button__order'>Вернуться на сайт</button></div>
      </div>
  </section>;
};
